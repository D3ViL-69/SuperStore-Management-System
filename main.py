...
def mainwindow(pi):
    ...
    titframe = Frame(MainFrame, bg='navajo white', bd=6, pady=3, relief=RIDGE)
    ...
    lblTitle = Label(titframe, font=('Segoe UI', 30, 'bold'), text="SUPERSTORE MARKET",
                     bd=21, bg='gray1', fg='chartreuse2', justify=CENTER)
    lblTitle.grid(row=2, column=0, padx=380)

    # ----------------------- Customer frame label -------------------

    lblcustitfrm = Label(custitfrm, font=('Lucida Fax', 15, 'bold'), text='Customer Details',
    ...
    srchbutton = Button(srchcutfrm, text='Data Base\nCharts', font=('Lucida Fax', 14, 'bold'),
                        width=12, bg='bisque4', command=lambda: db_chrt_btn(pwd, MainFrame))
    ...
    resetbtn = Button(srchcutfrm, text='Reset All', font=('Microsoft YaHei Light', 14, 'bold'), width=10,
                      height=2, bg='burlywood3', command=lambda: reset_all(textreciept, biltbl, namEntry))
    resetbtn.grid(row=0, column=1, padx=5)
    resetbtn.bind('<Enter>', pf.E_resetbtn)
    resetbtn.bind('<Leave>', pf.L_resetbtn)

    prntbtn = Button(btnfrm1, text='Print Bill', font=('Microsoft YaHei Light', 14, 'bold'),width=8,height=2,
                     
                     bg='medium aquamarine',  command=lambda: prnt_bill(textreciept))
    prntbtn.grid(row=0, column=2,padx=5)
    ...
    ttlbtn = Button(btnfrm1, text='Re-Generate', width=12, font=('Microsoft YaHei Light', 17, 'bold'),
    ...
    billbtn = Button(btnfrm2, text='Generate Bill', width=13, font=('Microsoft YaHei Light', 17, 'bold'),
    ...
    extbtn = Button(btnfrm2, text='Log Out', width=8, font=('Microsoft YaHei Light', 17, 'bold'),
    ...
    slp = Label(cus1, text="SLIP NO.      :     ", font=('Gabriola', 22, 'bold'), bg='gold3')
    ...
    dte = Label(cus1, text="Date\t     :     ", font=('Gabriola', 22, 'bold'), bg='gold3')
    ...
    nam = Label(cus1, text="Name\t     :     ", font=('Gabriola', 22, 'bold'), bg='gold3')
    ...
    pno = Label(cus1, text="Phone No.    :     ", font=('Gabriola', 22, 'bold'), bg='gold3')
    ...
    adres = Label(cus1, text="Address       :     ", font=('Gabriola', 22, 'bold'), bg='gold3')
...
def log_in_page():
    ...
    fgtfrm = Frame(btmfrm, bd=4, bg='antique white', relief=RIDGE)
    fgtfrm.pack(after=btnfrm, pady=10)

    extfrm = Frame(btmfrm, bd=4, bg='antique white', relief=RIDGE)
    extfrm.pack(after=fgtfrm, pady=10)
...
#    pswdlbl = Label(pswdfrm, text='made by shibansu ', font=('MS PGothic', 26, 'bold'), bg='LIGHTGREEN')
 #   pswdlbl.grid(row=6, column=1, sticky=W, padx=20, pady=20)

    # _-_-_-_-_-_-_-_-_-_-_-_-_-_ BUTTONS _-_-_-_-_-_-_-_-_-_-_-_-_

    crtbtn = Button(btnfrm, text='Create New User', font=('Myanmar Text', 20, 'bold'),
                    bd=3, width=16, height=1, bg='cyan', command=lambda: go_to_create(LogFrame))
    crtbtn.pack(side=LEFT)
    crtbtn.bind('<Enter>', pf.E_crete_n_usr)
    crtbtn.bind('<Leave>', pf.L_crete_n_usr)

    lginbtn = Button(btnfrm, text='Log In', font=('Myanmar Text', 20, 'bold'), bd=3,
                     width=10, height=1, bg='medium sea green', command=logging)
    lginbtn.pack(side=RIGHT)
    lginbtn.bind('<Enter>', pf.E_lg_login_btn)
    lginbtn.bind('<Leave>', pf.L_lg_login_btn)

    fgtbtn = Button(fgtfrm, text='Forgot Pass', font=('Yu Gothic UI Semibold', 20, 'bold'), bd=3,
                    width=10, height=2, bg='cyan') #command=lambda: pf.exit_btn(window)
    fgtbtn.grid(row=5,column=0)
    fgtbtn.bind('<Enter>', pf.E_exitbtn)
    fgtbtn.bind('<Leave>', pf.L_lgextbtn)
